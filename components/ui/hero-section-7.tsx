...
export const Swirls = () => (
    <>
        <svg
            className="absolute top-0 left-0 -translate-x-1/3 -translate-y-1/3 text-pink-200/40 dark:text-pink-900/20"
            width="600"
            height="600"
            viewBox="0 0 600 600"
            fill="none"
        ...
        <svg
            className="absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4 text-pink-200/40 dark:text-pink-900/20"
            width="700"
            height="700"
            viewBox="0 0 700 700"
            fill="none"
...
export function FloatingFoodHero({
    ...
    return (
        <section
            className={cn(
                'relative w-full min-h-[60vh] lg:min-h-[80vh] flex items-center justify-center overflow-hidden bg-bg-primary py-20 md:py-32',
                className
            )}
        >
            ...
            {/* Text Content */}
            <div className="relative z-20 container-custom text-center max-w-4xl">
                <h1 className="text-4xl font-bold tracking-tight text-primary sm:text-5xl md:text-6xl font-playfair">
                    {title}
                </h1>
